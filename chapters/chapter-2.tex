...
Apache Solr, which power the city search functionality. Section~\ref{REL_WIKIDATA}
explains the role of Wikidata for reverse geocoding. Section~\ref{REL_WL}
describes the Walter-Lieth climatogram.
