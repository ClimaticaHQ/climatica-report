...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-v1.png}
...
\texttt{wbsearchentities} call followed by a SPARQL filter query. The
limitations of this approach are discussed at the end of this section;
the following paragraphs describe the replacement pipeline.
...
\textbf{Why GeoNames and Solr instead of Wikidata.} The migration from
Wikidata city search to a locally hosted Solr index was motivated by two
concrete limitations. First, Wikidata applies soft-throttling to high-frequency
queries from a single origin, causing intermittent failures under rapid typing.
Second, promoting more populous cities in the results --- for example, ensuring
that Paris, France ranks above smaller cities named Paris --- required
post-processing logic on top of the SPARQL results, whereas Solr supports
native field boosting via the \texttt{population} field in the schema.
The GeoNames dataset also provides broader and more consistent coverage than
...
\begin{sidewaystable}[p]
  ...
  \label{tab:state}
  \small
  \begin{tabular}{p{4cm}p{3.5cm}p{10cm}}
    \toprule
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-map.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-columns-graph.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-walter-lieth.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-compare-cities.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-compare-periods-climate.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-compare-periods-weather.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-heatmap-bbox.png}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{Images/climatica-heatmap-polygon.png}
